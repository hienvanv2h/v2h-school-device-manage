...
public class ColumnMapping {
    ...
    public static final Map<Class<?>, Map<String, String>> COLUMN_TRANSLATIONS = new LinkedHashMap<>();

    static {
        COLUMN_TRANSLATIONS.put(UserDTO.class, new LinkedHashMap<>() {{
            put("userId", "#");
            put("username", "Tên tài khoản");
            put("fullName", "Họ và tên");
            put("phoneNumber", "Số điện thoại");
            put("role", "Quyền hạn");
            put("isActive", "Trang thái");
            put("createdAt", "Ngày tạo");
            put("updatedAt", "Ngày cập nhật");
        }});

        COLUMN_TRANSLATIONS.put(Subject.class, new LinkedHashMap<>() {{
            put("subjectId", "#");
        ...
        COLUMN_TRANSLATIONS.put(SchoolClass.class, new LinkedHashMap<>() {{
            put("classId", "#");
        ...
        COLUMN_TRANSLATIONS.put(Teacher.class, new LinkedHashMap<>() {{
            put("teacherId", "#");
            put("fullName", "Họ và tên");
            put("email", "Email");
            put("phoneNumber", "Số điện thoại");
        ...
        COLUMN_TRANSLATIONS.put(DeviceCategory.class, new LinkedHashMap<>() {{
            put("categoryId", "#");
        ...
        COLUMN_TRANSLATIONS.put(DeviceCategorySubject.class, new LinkedHashMap<>() {{
            put("id", "#");
        ...
        COLUMN_TRANSLATIONS.put(Device.class, new LinkedHashMap<>() {{
            put("deviceId", "#");
            put("deviceName", "Tên thiết bị");
            put("categoryId", "Loại thiết bị");
            put("totalQuantity", "Số lượng ban đầu");
            put("remainingQuantity", "Số lượng còn lại");
            put("description", "Mô tả");
        ...
        COLUMN_TRANSLATIONS.put(Semester.class, new LinkedHashMap<>() {{
            put("semesterId", "#");
        ...
        COLUMN_TRANSLATIONS.put(TeacherAssignmentDTO.class, new LinkedHashMap<>() {{
            put("assignmentId", "#");
        ...
        COLUMN_TRANSLATIONS.put(ScheduleProjection.class, new LinkedHashMap<>() {{
            put("scheduleId", "#");
        ...
        COLUMN_TRANSLATIONS.put(DeviceRegistrationDTO.class, new LinkedHashMap<>() {{
            put("registrationId", "#");
